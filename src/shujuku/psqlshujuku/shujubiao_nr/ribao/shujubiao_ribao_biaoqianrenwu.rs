...
const ziduanlie: &[Ziduandinyi] = &[
    ...
    Ziduandinyi { mingcheng: "zhuangtai", nicheng: "任务状态", jieshao: "任务状态，true已完成，processing处理中，false待处理，shibai失败", leixing: "TEXT NOT NULL CHECK (zhuangtai IN ('true','false','processing','shibai'))", morenzhi: Some("false") },
