...
pub fn huoqujiekoulie() -> Vec<Jiekouzhucexinxi> {
    vec![
        ...
        Jiekouzhucexinxi { qianzhui: ai_qianzhui, dinyi: &ai::jiekou_aidiaoduqi_gengxin::dinyi },
        Jiekouzhucexinxi { qianzhui: ai_qianzhui, dinyi: &ai::jiekou_aidiaoduqi_jiankong::dinyi },
